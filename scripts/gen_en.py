...
DICT = [
    ...
    ("Pokoje wakacyjne z łazienkami", "Summer rooms with private bathrooms"),
    ("Pokoje wakacyjne", "Summer rooms"),
    ...
    ("Zobacz wszystkie zdjęcia (18)", "See all photos (18)"),
    ("18 zdjęć", "18 photos"),
    ("Pokój letni", "Summer room"),
    ("Łóżka", "Beds"),
    ("Wnętrze", "Interior"),
